...
; name of the work sheet name to open
$worksheet  = "BLUE"
...
$item_name_str  = _Excel_RangeRead($oWorkbook, $worksheet, $item_name_cell_str)
...
While (StringCompare($item_name_str, ""))
   ...
   $item_qty_value_str = _Excel_RangeRead($oWorkbook, $worksheet, $item_qty_cell_str)

   ; obtain item price in market
   $item_price_cell_str  = "C" & String($current_line)
   $item_price_value_str = _Excel_RangeRead($oWorkbook, $worksheet, $item_price_cell_str)
